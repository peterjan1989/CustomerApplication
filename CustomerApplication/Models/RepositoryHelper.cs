namespace CustomerApplication.Models
{
	public static class RepositoryHelper
	{
		...
		public static RepostViewRepository GetRepostViewRepository()
		{
			var repository = new RepostViewRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static RepostViewRepository GetRepostViewRepository(IUnitOfWork unitOfWork)
		{
			var repository = new RepostViewRepository();
